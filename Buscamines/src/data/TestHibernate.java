...
public class TestHibernate {
	...
	public static void main(String[] args) {
		 ...
		 * /*session.beginTransaction(); Nivell easy = new Nivell();
		 * easy.setNom("Easy"); easy.setNombreCasellesXColumna(5);
		 * easy.setNombreCasellesXFila(5); easy.setNombreMines(5);
		 * 
		 * session.save(easy);
		 * 
		 * Nivell normal = new Nivell(); normal.setNom("Normal");
		 * normal.setNombreCasellesXColumna(15);
		 * normal.setNombreCasellesXFila(15); normal.setNombreMines(15);
		 * 
		 * session.save(normal); session.getTransaction().commit(); Query query
		 * = session.createQuery("from Nivell"); List<?> allNivells =
		 * query.list(); Nivell nivell = (Nivell)allNivells.get(0);
		 * System.out.println("Level printing:");
		 * System.out.println(allNivells); System.out.println("Level printed");
	...
	public static void getLevel(String nom) {
		...
		if (nivell == null) System.out.println("meeec");
		else {
